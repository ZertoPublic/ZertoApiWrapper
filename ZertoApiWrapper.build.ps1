...
task FileTests CheckPesterInstalled, {
    ...
    $script:results = Invoke-Pester -Script "$BuildRoot" -Tag Unit -OutputFile $testResultsFile -PassThru -CodeCoverage "$BuildRoot\ZertoApiWrapper\Public\*" -CodeCoverageOutputFile $codeCoverageFile
